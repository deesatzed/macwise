...
| MW-603 | 7 | Deliver the simple novice checkup journey in `GOAL_SIMPLE_UX.md` | in progress | 415-test full gate, isolated Python 3.12 wheel, and real-Mac aggregate checkup pass; current landing-page desktop/mobile render and hosted CI remain pending |

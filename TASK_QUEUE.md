...
| MW-600 | 7 | Public docs, privacy/security review, packaging, CI, Homebrew, release candidate | partial | Local RC PASS; public release blocked on authority, hosted CI/release, Xcode 27 formula audit/install, and public install proof |

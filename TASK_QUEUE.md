...
| MW-604 | 8 | Build the independent evaluation lab in `GOAL_EVAL.md` | ready | Requires isolated evaluator boundary, frozen oracle/policy, mutation adequacy, versioned scenario replay, disposable action proof, hosted macOS comparison, and private real-Mac aggregate evidence |

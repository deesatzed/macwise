...
| D-043 | 2026-07-20 | Version the minimal storage oracle from 1 to 2 and require the serialized mounted-free-space limitation. | The first calibration enforcement exposed a mismatch between the prior oracle wording and the fixture's actual storage limitation. The new wording is the independently defensible storage boundary and the change is recorded before replay. | Silently ignore required uncertainty; alter evaluator matching; retain the mismatched wording. | Accepted |
